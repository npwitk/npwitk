...
- **Movie Buff Mode** 🎬: I’ll watch literally any movie and immediately rate or review it on Letterboxd. If a film’s really good, I’ll passionately recommend it to my friends (who never actually watch it, hahA).
- **Bookworm Energy** 📚: I’ve been buying way too many books lately (seriously considering getting a Kindle). Whether it’s self-development, fiction, or non-fiction, you name it, I’m into it. The stack keeps growing faster than I can read.
...
- **Nickname**: <img src="https://raw.githubusercontent.com/npwitk/npwitk.github.io/refs/heads/main/assets/google-svg.svg" alt="Google" style="width: 65px; height: auto;">—yes, it's my real nickname! (And no, I haven’t received any merch from Google like others with this name, lol, please!)
- **Current Obsession**: RAG, Books, Workout, Robotics

---

### 🛠️ Skills & Technologies

- **Languages**: Thai, English, Python, Java, Swift, LaTeX (not a language), Mathematica (is that count?), and a liiiiittle bit of C++ 😉
